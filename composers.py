"""
    Components which help in composing combinations of
    Generators and modifiers for generating diff
    kind of waves
"""
...
class Chain:
    """
        Component for chaining a single
        generator with multiple modifiers
        after it.
    """
